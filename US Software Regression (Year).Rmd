...
omnibus_US <-right_join(econ, software, by = "Date") %>%
  ...
  mutate(`Inflation %` = as.numeric(`US.Inflation..annual...`),
         ...
         `CCI` = as.numeric(CCI)) %>%
  select(1,9:15,8)
omnibus_USi <- omnibus_US[-c(40:63),]
```
#Interesting Graphs
...
```{r}
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + CCI:`GDP pc growth %`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + CCI:Unemployment, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + Unemployment:`GDP pc growth %`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + CCI:Unemployment:`GDP pc growth %`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + CCI:`GDP pc growth %` + CCI:Unemployment, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + CCI:`GDP pc growth %` + Unemployment:`GDP pc growth %`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc growth %` + Unemployment + Unemployment:`GDP pc growth %` + CCI:Unemployment, data = omnibus_USi))

summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + CCI:`GDP pc`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + CCI:`Lending interest rate`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + `GDP pc`:`Lending interest rate`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + `GDP pc`:`Lending interest rate` + CCI:`GDP pc`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + CCI:`GDP pc`:`Lending interest rate`, data = omnibus_USi))
summary(lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + CCI:`GDP pc` + CCI:`GDP pc`:`Lending interest rate`, data = omnibus_USi))
```

#Liniar Model

```{r}
#omnibus_USi_lm <- lm(Software ~ CCI + `GDP pc` + `Lending interest rate` + CCI:`GDP pc`, data = omnibus_USi)
omnibus_USi_lm <- lm(Software ~ CCI + `GDP pc growth %` + Unemployment + Unemployment:`GDP pc growth %` + CCI:Unemployment, data = omnibus_USi)
