...
```{r}
econ <- read.csv('C:/BYU/2023(1) Winter/Video Game Case Study/Video-Game-Sales-Project/Indicators_edit.csv') %>%
  mutate(year = Year) %>%
  select(15,3:14)

hardware_global <- read.csv('C:/BYU/2023(1) Winter/Video Game Case Study/Video-Game-Sales-Project/USA_Sales_vs_CCI.csv') %>%
...
bestsub_bic <- bestglm(omnibus_USi,
                        IC = "BIC",
                        method = "exhaustive")
summary(backward_bic$BestModel)
```
