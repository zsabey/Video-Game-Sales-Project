...
grid.arrange(scat_CCI, scat_Inflation, scat_GDPgrowth, scat_GDP, scat_InterestRate, scat_Unemployment, scat_CPI, ncol =3)
```
...
summary(lm(Hardware ~ CCI + `GDP pc` + `Lending interest rate`, data = omnibus_USi))
...
newdata = data.frame(CCI = 98.94, `GDP pc` = 69288, `Lending interest rate`= 3.25) %>%
